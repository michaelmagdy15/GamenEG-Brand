...
export const products: Product[] = [
  {
    ...
    description:
      'The GAMÉN Signature is where it all began — a hand-carved walnut bow tie crowned with a solid brass MF monogram. Every curve is sculpted to sit naturally at the collar, turning the ordinary into the unmistakable. Finished with a satin-matte lacquer that deepens with time.',
    ...
    careNote:
      'Wipe gently with a dry microfiber cloth. Avoid prolonged moisture exposure. Store in the included wooden case.',
  },
  {
    id: 'bt-two-tone',
    slug: 'two-tone-grain',
    ...
    description:
      'A study in duality — the Two-Tone Grain pairs the warmth of blonde sycamore with the gravity of dark walnut. The seamless join is invisible to the eye but unmistakable to the touch, a testament to millimetre-precision hand fitting.',
    ...
    careNote:
      'Apply a drop of tung oil every 6 months to maintain lustre. Avoid direct sunlight for extended periods.',
  },
  {
    id: 'bt-eye-of-horus',
    slug: 'eye-of-horus',
  ...
  },
  {
    ...
    description:
      'Stripped of embellishment, the Dark Classic lets the wood speak. A single piece of hand-oiled ebony-stained walnut, sculpted into the purest bow tie form. For the man who needs nothing more than impeccable material.',
    ...
    careNote:
      'Re-oil with natural tung oil every 3–4 months for optimal depth. Avoid chemical cleaners.',
  },
  {
    id: 'bt-hero',
    slug: 'classic-walnut',
    ...
    description:
      'The entry point to the GAMÉN universe. Carved from selected walnut with a natural matte finish, the Classic Walnut is understated yet undeniable. The proportions are calibrated for a clean silhouette that complements any collar.',
  ...
  },
  {
    ...
    description:
      'The GAMÉN Époque extends our woodcraft philosophy to the wrist. A fully handcrafted wooden timepiece featuring a walnut case, stainless steel movement housing, and a multi-link wooden bracelet. The dial face uses a geometric wood inlay pattern that catches light differently with every glance.',
    ...
    careNote:
      'Avoid submerging in water. Wipe with a slightly damp cloth if needed. Apply wood conditioner every 6 months. Store in the included box when not worn.',
  },
];
